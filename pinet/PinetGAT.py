            ...
            for train_size in train_sizes:
                ...
                for split in range(num_folds):
                    ...
                    #test_loader = DataLoader(test_dataset, batch_size=10, shuffle=False)
                        ...
                        run = wandb.init(reinit=True, project="PINET_GAT")
                        ...
                        for epoch in range(200):
                            ...
                            log_file.flush()
                            wandb.log({"loss_PiNet_GAT": np.mean(train_loss),"Train accuracy_PiNet_GAT": train_acc, "Test acuuracy_PiNet_GAT":test_acc, 'precision_1_PiNet_GAT':precision_1,'recall_1_PiNet_GAT':recall_1,'precision_0_PiNet_GAT': precision_0,'recall_0_PiNet_GAT': recall_0, 'f1_0_PiNet_GAT':f1_0, 'f1_1_PiNet_GAT':f1_1})
                        run.finish()