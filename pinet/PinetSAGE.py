        ...
        for model_dict in models:
            for train_size in train_sizes:
                ...
                for split in range(num_folds):
                    ...
                    for split, (all_train_idx, test_idx) in enumerate(list):
                    ...
                    #test_loader = DataLoader(test_dataset, batch_size=10, shuffle=False)
                        ...
                        run = wandb.init(reinit=True, project="PINET_SAGE")
                        ...
                        WEIGHTS = torch.FloatTensor([1, CLASS_1_WEIGHT])
                        ...
                        for epoch in range(200):
                            ...
                            log_file.flush()
                            wandb.log({"loss_PiNet_SAGE": np.mean(train_loss),"Train accuracy_PiNet_SAGE": train_acc, "Test acuuracy_PiNet_SAGE":test_acc, 'precision_1_PiNet_SAGE':precision_1,'recall_1_PiNet_SAGE':recall_1,'precision_0_PiNet_SAGE': precision_0,'recall_0_PiNet_SAGE': recall_0, 'f1_0_PiNet_SAGE':f1_0, 'f1_1_PiNet_SAGE':f1_1})
                        run.finish()